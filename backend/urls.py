...
urlpatterns = [
    ...
    path('api/recommendations/<owner>/', up_views.RecommendationRetrieveView.as_view(), name="retrieve_recommendations"),
    ...
    path('api/all/likes/<str:username>/',up_views.AllUserLikesView.as_view(),name="all_user_likes"),
    path('api/search/people/<str:word_to_search>/',up_views.SearchPeopleRetrieveView.as_view(), name="search_people_view"),
    path('api/search/hashtag/<str:word_to_search>/',up_views.SearchHashtagRetrieveView.as_view(), name="search_hashtag_view"),
