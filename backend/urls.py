...
urlpatterns = [
    ...
    path('<username>/', up_views.CustomUserDetailView.as_view(), name="user_detail_view" ),
    ...
    path('<str:username>/followers/', up_views.UserFollowersListView.as_view(),name="user_followers"),
    path('<str:username>/following/', up_views.UserFollowingListView.as_view(),name="user_following"),
    path('home-recommendations/<int:pk>/', up_views.HomeRecommendationsView.as_view(), name="all_following_recommendations"),
    path('<str:username>/recommendations/<int:pk>/', up_views.RecommendationDetailView.as_view() , name="recommendation_detail"),
    ...
    path('notifications/<int:pk>/', up_views.NotificationsListView.as_view(), name='notifications'),
